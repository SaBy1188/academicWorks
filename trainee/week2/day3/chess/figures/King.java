...
public class King extends ChessPiece {
    ...
    public boolean canMove(int toX,int toY) {
        ...
        // aufruf Methode Elternklasse

        // auslagern in Elternklasse
        ...
        // Bedingungen (alle Richtungen, immer nur 1 Schritt)
        // deltaX == 1 && deltaY == 0 UND
        // deltaX == 0 && deltaY == 1 UND
        // deltaX == 1 && deltaY == 1 -> diagonal
